      ...
      <section className="bg-primary py-16 text-primary-foreground">
        <div className="container">
          ...
          <p className="max-w-2xl text-lg text-primary-foreground/80">
            Кафедра прикладной математики и компьютерного моделирования НИУ «БелГУ» — 
            ...
            <div>
              ...
              <div className="space-y-4 text-muted-foreground">
                <p>
                  ...
                  в составе Института инженерных и цифровых технологий Белгородского государственного 
                  национального исследовательского университета (НИУ «БелГУ»).
                </p>
                <p>
                  За годы работы кафедра подготовила сотни специалистов, которые успешно работают 
                  в IT-компаниях, научных организациях и образовательных учреждениях региона и страны.
                </p>
                <p>
                  Сегодня кафедра активно развивает научные направления в области 
                  математического моделирования, машинного обучения и анализа больших данных.
                </p>
              </div>
            </div>
            <div>
