...
const features = [
	{
		...
		description:
			'Изучение методов построения и анализа математических моделей реальных процессов',
	},
	{
		icon: BookOpen,
	...
	},
	{
		...
		description:
			'Участие в актуальных научных проектах под руководством ведущих специалистов',
	},
	{
		icon: GraduationCap,
...
const news = [
	...
	},
	{
		...
		description:
			'Кафедра провела ежегодную конференцию по математическому моделированию.',
	},
	{
		date: '10 декабря 2025',
		title: 'Новый выпуск газеты «ВЕСТИ БелГУ»',
		description:
			'Вышел новый номер университетской газеты с материалами о достижениях кафедры.',
	},
]
				...
				<div className='container relative'>
					<div className='mx-auto max-w-3xl text-center'>
						...
						<p className='mb-8 text-lg text-primary-foreground/80 sm:text-xl'>
							Готовим специалистов будущего в области математического
							моделирования, анализа данных и информационных технологий
						</p>
				...
				<div className='container'>
					<div className='mb-6 text-center'>
						<p className='text-sm text-muted-foreground'>
							НИУ «БелГУ» — один из ведущих исследовательских университетов
							России
						</p>
					</div>
				...
				<div className='container'>
					<div className='mx-auto mb-12 max-w-2xl text-center'>
						...
						<p className='text-muted-foreground'>
							Мы создаём условия для качественного образования и научного
							развития
						</p>
					</div>
				...
				<div className='container'>
					<div className='mx-auto max-w-3xl text-center'>
						...
						<p className='mb-8 text-muted-foreground'>
							Свяжитесь с нами для получения дополнительной информации о кафедре
